...
class SnakeScene extends Phaser.Scene {
  constructor() {
    ...
    this.load.image("food","/games/snake/assets/apple.png");
    this.load.image("snakeRight","/games/snake/assets/head_right.png");
    this.load.image("snakeLeft","/games/snake/assets/head_left.png");
    this.load.image("snakeUp","/games/snake/assets/head_up.png");
    this.load.image("snakeDown","/games/snake/assets/head_down.png");
    this.load.image("bodyHorizontal","/games/snake/assets/body_horizontal.png");
    this.load.image("bodyVertical","/games/snake/assets/body_vertical.png");
    this.load.image("bodyRightUp","/games/snake/assets/body_rightup.png");
    this.load.image("bodyRightDown","/games/snake/assets/body_rightdown.png");
    this.load.image("bodyDownRight","/games/snake/assets/body_downright.png");
    this.load.image("bodyUpRight","/games/snake/assets/body_upright.png");
    this.load.image("tailRight","/games/snake/assets/tail_right.png");
    this.load.image("tailLeft","/games/snake/assets/tail_left.png");
    this.load.image("tailUp","/games/snake/assets/tail_up.png");
    this.load.image("tailDown","/games/snake/assets/tail_down.png");
    this.load.image("background","/games/snake/assets/bg.png");
    this.load.audio("eat","/games/snake/assets/eat.mp3");
    this.load.audio("hit","/games/snake/assets/hit.wav");
  }
