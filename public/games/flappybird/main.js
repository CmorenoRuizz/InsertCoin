...
function preload() {
  this.load.image("background","/games/flappybird/assets/GameObjects/background-day.png");
  this.load.image("character1","/games/flappybird/assets/GameObjects/yellowbird-midflap.png");
  this.load.image("character2","/games/flappybird/assets/GameObjects/yellowbird-downflap.png");
  this.load.image("character3","/games/flappybird/assets/GameObjects/yellowbird-upflap.png");
  this.load.image("character4","/games/flappybird/assets/GameObjects/yellowbird-fall.png");
  this.load.image("pillar","/games/flappybird/assets/GameObjects/pipe-green.png");
  this.load.image("base","/games/flappybird/assets/GameObjects/base.png");
  this.load.image("gameover","/games/flappybird/assets/UI/gameover.png");
  this.load.image("score","/games/flappybird/assets/UI/score.png");
  this.load.image("retry","/games/flappybird/assets/UI/retry.png");
  this.load.image("startGame","/games/flappybird/assets/UI/message.png");
  this.load.audio("score","/games/flappybird/assets/SoundEffects/point.wav");
  this.load.audio("hit","/games/flappybird/assets/SoundEffects/hit.wav");
  this.load.audio("wing","/games/flappybird/assets/SoundEffects/wing.wav");
  this.load.audio("die","/games/flappybird/assets/SoundEffects/die.wav");
}
